...
class MaestraClient extends EventEmitter {
  ...
  constructor(options = {}) {
    ...
    this.options = {
      ...
      voiceOverEnabled: options.voiceOverEnabled !== undefined ? options.voiceOverEnabled : false,
  ...
  _initWebSocketClient() {
    ...
    this.websocketClient = new WebSocketClient(
      ...
      this.options.port, 
      {
        ...
        voiceOverEnabled: this.options.voiceOverEnabled,
    ...
    this.websocketClient.on('finalizedSegmentAudioURL', (audioURL) => {
      ...
      if (this.options.voiceOverEnabled && audioURL) {
